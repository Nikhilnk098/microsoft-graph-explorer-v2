...
* To make few changes to an article, [Contribute using GitHub](#contribute-using-github).
...
1.	In the Git Bash command prompt, type `git checkout dev`. This ensures that you aren't in the branch to be deleted (which isn't allowed).
